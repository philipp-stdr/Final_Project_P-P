...
The section includes two figures, one of the distribution of income and one of the relationship between respondent's income and reported happiness. 
...
**I think we should start our analysis section here.** But we of course needs a real analysis introduction. 

## Marriage / family constellation, income and happiness

**<The text needs to be updated - we now show marriage constellation, not family constellation.>**
...
```    
*NOTE: Table1: There is a problem with the omit.labels function.* 

**Figure: Interaction between marriage and high-income**
...
```    
**Table 2: The omit.label function is still bugging!!!!!!!!**
...
In the next step we investigate the impact of the spouse's work status on marriage happiness. We choose a different dependent variable in this model because we want to isolate the preference of individuals for spouses work status for a satisfying family life. While life satisfaction might be impacted by job satisfaction, health and other endogenous or unobservable factors, marriage happiness focuses on the couples' relationship that we assume is fundamental for a satisfying family life.

Our fourth model shows the same model specifications for two different sample restrictions. Specficiation 1 and 2 limit the sample to married, college-educated individuals. Specification 3 and 4 further limit the sample to the individuals of the former group who have a high income. The coefficients from specification 1 and 2 point in the expected directions. Women report higher happiness with marriage when their men work full-time, while men report the oppiste although at much lower magnitude. Men report however higher happiness when their spouse stays at home[^omit].

[^omit]: We omitted the coefficient for women's spouses who stay at home due to too few observations.

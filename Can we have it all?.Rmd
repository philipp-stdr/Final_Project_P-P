...
```{r,warning=FALSE,echo=FALSE,Cache=TRUE,fig.cap="Figure 4: Happiness and family constellation"}
...
```{r, warning=FALSE,echo=FALSE,Cache=TRUE,fig.cap="Figure 5: Interaction effects of marriage and job income on life satisfaction"}

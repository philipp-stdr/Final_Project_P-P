...
## Gender and age
```{r,warning=FALSE,echo=FALSE,fig.cap="Figure 2: Happiness and age"}
ggplot() + 
...
```{r,fig.heigth=4,warning=FALSE,echo=FALSE,fig.cap="Figure 3: Happiness and labour-market affiliation"}
...
```{r,warning=FALSE,echo=FALSE,Cache=TRUE,fig.cap="Figure 5: Happiness and family constellation"}
z$meanhap <- NA
...
```    
*Sample restricted to college educated men and women*

## Illustration of interaction effect

```{r, warning=FALSE,echo=FALSE,Cache=TRUE,fig.cap="Figure 6: Interaction effects of marriage and job income on life satisfaction"}

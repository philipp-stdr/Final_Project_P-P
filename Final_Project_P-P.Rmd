...
```{r,fig.heigth=5,warning=FALSE,echo=FALSE,cache=TRUE,results='asis'}
...
ge_sp_ca <- table(z$sexcat[z$educat==4 & z$married==1], z$income_status[z$educat==4 & z$married==1], z$spwrkcat[z$educat==4 & z$married==1]) 
ftable(ge_sp_ca)
